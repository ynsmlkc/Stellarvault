...
export const metadata: Metadata = {
  title: "Stellar Vault — Confidential Multi-Sig Treasury",
  description:
    "The first confidential multi-sig treasury on Stellar. Approve as a team, reveal nothing — every transaction runs transparent or private behind zero-knowledge proofs.",
};
