...
let loadUltraHonkBackend = async () => (await import("@aztec/bb.js")).UltraHonkBackend;
/**
 ...
 */
export function setUltraHonkBackendLoader(loader) {
 ...
 */
export function proverFromArtifact(artifact) {
    return new CircuitProver(artifact);
}
