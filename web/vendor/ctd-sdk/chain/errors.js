...
export const CONTRACT_ERRORS = {
    ...
    3602: "This account is not permitted by the token's compliance policy (allowlist/blocklist). Ask the admin to allow it.",
...
export function parseContractErrorCode(raw) {
 ...
 */
export function humanizeContractError(raw) {
