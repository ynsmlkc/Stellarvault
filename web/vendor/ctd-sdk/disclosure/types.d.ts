...
export declare const DISCLOSE_RECIPIENT_CIRCUIT_ID = "disclose_recipient";
/** D-sender (§7): "this on-chain payment was sent by me for this amount". */
export declare const DISCLOSE_SENDER_CIRCUIT_ID = "disclose_sender";
export type DisclosureCircuitId = typeof DISCLOSE_RECIPIENT_CIRCUIT_ID | typeof DISCLOSE_SENDER_CIRCUIT_ID;
export declare const DISCLOSURE_CIRCUIT_IDS: readonly DisclosureCircuitId[];
