 ...
 */
import { H, ecdh, scalarMul } from "../crypto/grumpkin.js";
...
export function auditTransferSenderChannel(k, ev) {
...
export function auditTransferRecipientChannel(k, ev) {
    const sX = ecdh(k, ev.rE);
 ...
 */
export function auditTransfer(k, ev) {
 ...
 * the event.
 */
export function auditWithdraw(k, ev) {
    const sX = ecdh(k, ev.rE);
...
export function auditorPublicKey(k) {
